...
public class RhidService
{
    ...
    // Valores fixos da BigCard — não expostos ao usuário
    private const string FixedDomain    = "bigcard";
    private const string FixedCompanyId = "55477";
    ...
    public async Task<List<PunchRecord>> GetPunchRecordsTodayAsync()
    {
        ...
        for (int attempt = 1; attempt <= 3; attempt++)
        {
            ...
            try
            {
                ...
                request.Headers.Add("X-Cid-Rhid", FixedCompanyId);
