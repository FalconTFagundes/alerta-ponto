...
public class RhidConfig
{
    ...
    public string BaseUrl { get; set; } = "https://www.rhid.com.br/v2/api.svc";

    [JsonPropertyName("repp_url")]
    public string ReppUrl { get; set; } = "https://repp.rhid.com.br";
    ...
    // Fixos — não editáveis pelo usuário
    [JsonIgnore]
    public string Domain { get; set; } = "bigcard";
...
public class HorarioAtivo
{
    ...
    public string Inicio { get; set; } = "07:00";

    [JsonPropertyName("fim")]
    public string Fim { get; set; } = "19:00";
}
...
public class EventoConfig
{
    ...
    [JsonPropertyName("antecedencia_minutos")]
    public int AntecedenciaMinutos { get; set; } = 1;

    [JsonPropertyName("tolerancia_minutos")]
    public int ToleranciaMinutos { get; set; } = 3;
}
...
public class AlmocoConfig
{
    ...
    [JsonPropertyName("janela_inicio")]
    public string JanelaInicio { get; set; } = "11:00";

    [JsonPropertyName("janela_fim")]
    public string JanelaFim { get; set; } = "14:00";

    [JsonPropertyName("duracao_minutos")]
    public int DuracaoMinutos { get; set; } = 90;
...
public class MonitorConfig
{
    ...
    [JsonPropertyName("polling_proximo_seconds")]
    public int PollingProximoSeconds { get; set; } = 30;

    [JsonPropertyName("janela_proxima_minutos")]
    public int JanelaProximaMinutos { get; set; } = 5;
}
