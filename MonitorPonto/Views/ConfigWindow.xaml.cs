...
public partial class ConfigWindow : Window
{
    ...
    private void CarregarCampos()
    {
        ...
        TxtCompanyId.Text = _config.Rhid.CompanyId;
    ...
    private void BtnSalvar_Click(object sender, RoutedEventArgs e)
    {
        ...
        _config.Rhid.CompanyId   = TxtCompanyId.Text.Trim();
    ...
    private bool Validar()
    {
        ...
        if (string.IsNullOrWhiteSpace(TxtCompanyId.Text)) erros.Add("Company ID é obrigatório");
