...
public partial class ConfigWindow : Window
{
    ...
    private void CarregarCampos()
    {
        ...
        TxtIdPerson.Text     = _config.Person.IdPerson > 0
            ? _config.Person.IdPerson.ToString() : "";
    ...
    private string NomeAtual => string.IsNullOrWhiteSpace(TxtNome.Text) ? "Seu Nome" : TxtNome.Text.Trim();

    private void TesteEntradaAviso_Click(object sender, RoutedEventArgs e)
        => new AlertWindow(AlertTipo.Entrada, AlertNivel.Aviso,   NomeAtual, "08:00", "").Show();
    private void TesteEntradaUrgente_Click(object sender, RoutedEventArgs e)
        => new AlertWindow(AlertTipo.Entrada, AlertNivel.Urgente, NomeAtual, "08:00", "").Show();
    private void TesteAlmocoAviso_Click(object sender, RoutedEventArgs e)
        => new AlertWindow(AlertTipo.Almoco,  AlertNivel.Aviso,   NomeAtual, "12:00", "13:30").Show();
    private void TesteAlmocoUrgente_Click(object sender, RoutedEventArgs e)
        => new AlertWindow(AlertTipo.Almoco,  AlertNivel.Urgente, NomeAtual, "12:00", "13:30").Show();
    private void TesteSaidaAviso_Click(object sender, RoutedEventArgs e)
        => new AlertWindow(AlertTipo.Saida,   AlertNivel.Aviso,   NomeAtual, "18:00", "").Show();
    private void TesteSaidaUrgente_Click(object sender, RoutedEventArgs e)
        => new AlertWindow(AlertTipo.Saida,   AlertNivel.Urgente, NomeAtual, "18:00", "").Show();
}
